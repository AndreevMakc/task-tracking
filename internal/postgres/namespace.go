...
func (r *NamespaceRepo) GetByNamespaceId(
	ctx context.Context,
	namespaceId int64,
) (*domain.Namespace, error) {
	...
	err := r.pool.QueryRow(
		...
		query,
		namespaceId,
	).Scan(&namespace.ID, &namespace.Name, &namespace.CreatedAt, &namespace.UpdatedAt)
	if err != nil {
...
func (r *NamespaceRepo) GetByNamespaceName(
	ctx context.Context,
	...
	err := r.pool.QueryRow(ctx, query, namespaceName).
		Scan(&namespace.ID, &namespace.Name, &namespace.CreatedAt, &namespace.UpdatedAt)
	if err != nil {
